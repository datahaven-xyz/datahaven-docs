...
![Requesting tokens from the testnet faucet](/images/store-and-retrieve-data/networks/testnet-starter-kit/testnet-starter-kit-01.gif)

Testnet MOCK tokens have no market value. Please do not spam the faucet.

## MSP Service Endpoint (Testnet)
